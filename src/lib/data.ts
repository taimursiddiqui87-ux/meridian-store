...
export const products: Product[] = [
  {
    ...
    specs: baseSpecs({ case: "39mm brushed 316L steel", movement: "Automatic ZAM-01, 42-hour reserve" }),
    features: [
      "In-house ZAM-01 automatic movement",
...

  {
    ...
    features: [
      ...
      "Presented in the signature ZAMIRA case",
    ],
    rating: 4.9,
    reviewCount: 112,
    badge: "Bestseller",
...
export const heroBanners: HeroBanner[] = [
  {
    ...
    secondaryCta: { label: "The Aera 39", href: "/product/zamira-aera-39" },
  },
  {
    id: "hero-noir",
    eyebrow: "Signature",
    ...
    align: "center",
    theme: "dark",
    primaryCta: { label: "Discover Noir", href: "/product/zamira-noir-chronograph" },
  ...
  },
  {
    ...
    secondaryCta: { label: "Ambre Royale", href: "/product/ambre-royale" },
  },
  {
    id: "hero-jewelry",
...
export const promoBanners: PromoBanner[] = [
  ...
  },
  {
    ...
    body: "Every timepiece is regulated in six positions and pressure-tested before it ever reaches your wrist.",
